...
FUNCTION JPSENHADefault()
   ...
   IF Eof()
      ...
      FOR EACH oElement IN { "LJPTABEL", "PAUXCCUSTO", "PAUXFILIAL", "PSETUPEMPRESA", "PJPEMPRE", ;
         "PSETUPNUMERO", "PJPTABEL", "JPA_INDEX", "PUTI0020", "PUTI0022", "PADMINLOG", "PUPDATEEXEDOWN" }
         pw_GravaUsuarioAcesso( "GRUPOCONTABIL", oElement )
      NEXT
      ...
      NEXT
      FOR EACH oElement IN { "PBANCOGERA", "PBANCOLANCA", "PBANCOSALDO", "PBANCOCCUSTO", "PBANCOGRAFICOMES", "PBANCOCONSOLIDA", ;
         "PBANCOGRAFRESUMO", "PBANCORELEXTRATO", "PBANCOCOMPARAMES", "PBANCORELSALDO", "PBANCORELCCUSTO" }
