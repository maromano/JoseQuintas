...
MenuOption( "Movto" )
   ...
   MenuOption( "Pedidos/Notas Fiscais" )
      ...
      MenuOption( "Orçamentos/Pedidos SubOpções",,,"icosetup.ico" )
         MenuDrop()
         MenuOption( "(I)Ped.Cancelamento",               "ADMPEDCAN",,"icosetup.ico" )
         MenuOption( "(I)Ped.Reemite Cupom",              "ADMPEDCUP",,"icosetup.ico" )
         MenuOption( "(I)Ped.Duplicar Pedidos",           "ADMPEDCLO",,"icosetup.ico" )
         MenuOption( "(I)Ped.Fatura",                     "ADMPEDFAT",,"icosetup.ico" )
         MenuOption( "(I)Ped.Juntar Pedidos",             "ADMPEDJUN",,"icosetup.ico" )
         MenuOption( "(I)Ped.Libera Sem Estoque",         "ADMPEDEST",,"icosetup.ico" )
         MenuOption( "(I)Ped.Libera Sem Crédito",         "ADMPEDCRE",,"icosetup.ico" )
         MenuOption( "(I)Ped.Libera Sem Relacionado",     "ADMPEDREL",,"icosetup.ico" )
         MenuOption( "(I)Ped.Libera Pag Atraso",          "ADMPEDPAG",,"icosetup.ico" )
         MenuOption( "(I)Ped.Libera Cliente Bloqueado",   "ADMPEDBLO",,"icosetup.ico" )
         MenuOption( "(I)Ped.Nota Fiscal/Cupom",          "ADMPEDNOT",,"icosetup.ico" )
         MenuOption( "(I)Ped.Garantia",                   "ADMPEDGAR",,"icosetup.ico" )
         MenuOption( "(I)Ped.Libera Abaixo do Custo",     "ADMPEDCUS",,"icosetup.ico" )
         MenuOption( "(I)Ped.Libera diferente da tabela", "ADMPEDTAB",,"icosetup.ico" )
         MenuOption( "(I)Ped.Alterar Vendedor",           "ADMPEDVEN",,"icosetup.ico" )
         MenuOption( "(I)Ped.Gerar CTE",                  "ADMPEDCTE",,"icosetup.ico" )
         MenuOption( "(I)Ped.Barras Limpar Cód.Barras",   "ADMPEDLBA",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB1",       "ADMPEDLIB1",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB2",       "ADMPEDLIB2",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB3",       "ADMPEDLIB3",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB4",       "ADMPEDLIB4",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB5",       "ADMPEDLIB5",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB6",       "ADMPEDLIB6",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB7",       "ADMPEDLIB7",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB8",       "ADMPEDLIB8",,"icosetup.ico" )
         MenuOption( "(I)Ped.Transacao ADMPEDLIB9",       "ADMPEDLIB9",,"icosetup.ico" )
         MenuUndrop()
      MenuOption( "Nota Fiscal (Serviços)",            "PNOTASERVICO" )
      MenuOption( "Notas Fiscais",                     "PNOTACADASTRO" )
      MenuOption( "Notas Fiscais SubOpções",,,"icosetup.ico" )
         MenuDrop()
         MenuOption( "(I)Cancelamento de Nota Fiscal",    "ADMNOTCAN",,"icosetup.ico" )
         MenuOption( "(I)Cancelamento de NF-e",           "ADMNFECAN",,"icosetup.ico" )
         MenuOption( "(I)Carta de Correção",              "ADMNFECCE",,"icosetup.ico" )
         MenuUnDrop()
   ...
   MenuOption( "Boletos" )
      MenuDrop()
      MenuOption( "Boletos Itaú Notas (Txt)",      "PBOL0020",,"icofolderout.ico" )
      MenuOption( "Boletos Itaú Financeiro (Txt)", "PBOL0030",,"icofolderout.ico" )
      MenuOption( "Boletos Itaú Avulso (Txt)",     "PBOL0040",,"icofolderout.ico" )
      MenuOption( "Rel. Txt Itaú",                 "PBOL0050",, "icoprint.ico" )
      MenuOption( "Boletos p/ NF Emitidas",        "PBOL0060",, "icoprint.ico" )
      MenuOption( "Boletos p/ Doc.C.Receber",      "PBOL0061",, "icoprint.ico" )
      MenuOption( "Boletos Avulsos",               "PBOL0062",, "icoprint.ico" )
      MenuOption( "Boleto em PDF",                 "PTESTEBOLETO" )
      MenuUnDrop()
   MenuOption( "Opções NFE/CTE/MDFE" )
      MenuDrop()
      MenuOption( "Gera Dados para NFS-E / RPS",  "PNOTAGERARPS",,"icofolderout.ico" )
      MenuOption( "Gera Dados para NFEletrônica", "PNOTAGERANFE",,"icofolderout.ico" )
   ...
   MenuOption( "Preços/Comissões" )
      ...
      MenuOption( "(I)Compara Cotação",               "PPRECOMBUSTIVELZ",,"icosetup.ico" )
      MenuOption( "Preços Combustível",               "PPRETABCOMB" )
      MenuOption( "Preços Combustível Consulta",      "PPRETABCOMBP" )
      MenuOption( "Listagem Preços Combustível",      "PPRERELTABCOMB",, "icoprint.ico" )
      MenuOption( "Reajuste Preços Combustível",      "PPRETABCOMBREAJ" )
      MenuOption( "-", "-" )
      MenuOption( "Percentuais das tabelas",          "PAUXPPRECO",,"icosetup.ico" )
      MenuOption( "Alteração dos Precos",             "PPRETABELA",,"icosetup.ico" )
      MenuOption( "Lista de Preços",                  "PPRERELTABGERAL",, "icoprint.ico" )
      MenuOption( "Consulta/Alteração de Preços",     "PPREVALPERCA",,"icosetup.ico" )
      MenuOption( "Consulta de Preços",               "PPREVALPERCC" )
      MenuOption( "Lista de Preços Img",              "PPRERELTABMULTI",, "icoprint.ico" )
      MenuOption( "Preços - Percentuais das Tabelas", "PPREVALPERC",,"icosetup.ico" )
      MenuOption( "Html Tabela de Preços",            "PPREHTMLTABPRE",,"icofolderout.ico" )
      MenuOption( "-", "-" )
      MenuOption( "Arredondamento dos Preços",        "PSETUPPARAMROUND",,"icosetup.ico" )
      MenuOption( "Comissão de Vendedores",           "PJPCOMISS",,"icosetup.ico" )
      MenuUnDrop()
   MenuOption( "Etiquetas/Envelopes/Recibo" )
      MenuDrop()
      MenuOption( "Etiquetas p/ Embalagens", "PNOTAETIQUETA",, "icoprint.ico" )
      MenuOption( "Recibo de Uso Geral",     "PGERALRECIBO",, "icoprint.ico" )
      MenuUnDrop()
   MenuUnDrop()
...
MenuOption( "Financeiro" )
   ...
   MenuOption( "Bancário" )
      ...
      MenuOption( "Resumos e Grupos",             "PBANCOCCUSTO",,"icosetup.ico" )
...
MenuOption( "Contábil" )
   ...
   MenuOption( "Fechamento de Exercício",   "PCONTFECHA",,"icosetup.ico" )
   MenuOption( "Utilitários" )
      MenuDrop()
      MenuOption( "Atualização de Sintéticas",     "PCONTSINTETICA",,"icosetup.ico" )
      MenuOption( "Recálculo Geral",               "PCONTRECALCULO",,"icosetup.ico" )
      MenuOption( "Renumera Código Reduzido",      "PCONTREDRENUM",,"icosetup.ico" )
...
MenuOption( "Fiscal" )
   ...
   MenuOption( "Carta de Correção de NF",       "PFISCCORRECAO",,"icoprint.ico" )
   MenuOption( "Total de Lançtos LFiscal",      "PFISCTOTAIS" )
   MenuOption( "Tributação",,"icoingrenagem.ico" )
      MenuDrop()
      MenuOption( "Decretos/Leis",              "PLEISDECRETO",,"icosetup.ico" )
      MenuOption( "UFs (Unidades Federativas)", "PLEISUF",,"icosetup.ico" )
      MenuOption( "Tributação de Cadastros",    "PLEISTRICAD",,"icosetup.ico" )
      MenuOption( "Tributação de Empresa",      "PLEISTRIEMP",,"icosetup.ico" )
      MenuOption( "Tributação de Produtos",     "PLEISTRIPRO",,"icosetup.ico" )
      MenuOption( "Tributação de UFs",          "PLEISTRIUF",,"icosetup.ico" )
      MenuOption( "Regras de Tributação",       "PLEISIMPOSTO",,"icosetup.ico" )
      MenuUnDrop()
   MenuUnDrop()

MenuOption( "Relatórios" )
   MenuDrop()
   MenuOption( "Rel.Pedidos/NF/OS",,, "icoprint.ico" )
      MenuDrop()
      MenuOption( "Pedidos/Orçamentos",              "LJPPEDI",, "icoprint.ico" )
      MenuOption( "Rentabilidade por Produto",       "PNOTARELRENTAB",, "icoprint.ico" )
      MenuOption( "Clientes para Vendedor *TES*",    "PNOTAFICCLIVEN",, "icoprint.ico" )
      MenuOption( "Notas Fiscais Emitidas",          "PNOTARELNOTAS",, "icoprint.ico" )
      MenuOption( "Planilha Compras/Vendas Gerente", "PNOTAPLANILHAG",, "icoprint.ico" )
      MenuOption( "Planilha Compras/Vendas",         "PNOTAPLANILHACV",, "icoprint.ico" )
      MenuOption( "Planilha Vendas",                 "PNOTAPLANILHAC",, "icoprint.ico" )
      MenuOption( "Notas em Excel",                  "PNOTAXLS",, "icoprint.ico" )
      MenuOption( "Vendas a Clientes",               "PNOTARELCLIVEND",, "icoprint.ico" )
      MenuOption( "RMA/Baixa PE",                    "PNOTARELPEDREL",, "icoprint.ico" )
      MenuOption( "Rel.Mapa de Vendas-Pedidos",      "PNOTARELMAPA",, "icoprint.ico" )
      MenuOption( "Rel.Compara Meses Compra/Venda",  "PNOTARELCOMPMES",, "icoprint.ico" )
      MenuOption( "Rel.Comparativo Mensal",          "PNOTARELCOMPCLI",, "icoprint.ico" )
      MenuOption( "Vendas Mensais por Cliente",      "PNOTARELVENDCLI",, "icoprint.ico" )
      MenuUnDrop()
   MenuOption( "Rel.Bancário",,, "icoprint.ico" )
      MenuDrop()
      MenuOption( "Rel.Extrato de Conta(s)",        "PBANCORELEXTRATO",, "icoprint.ico" )
      MenuOption( "Rel.Saldos das Contas",          "PBANCORELSALDO",, "icoprint.ico" )
      MenuOption( "Rel.Movimento por Grupo/Resumo", "PBANCORELCCUSTO",, "icoprint.ico" )
      MenuUnDrop()
   MenuOption( "Rel.Estoque",,, "icoprint.ico" )
      MenuDrop()
      MenuOption( "Rel.Ent/Saí/Pos/Invent",         "LJPESTOQA",, "icoprint.ico" )
      MenuOption( "Rel.Entradas Forn/Item",         "LJPESTOQB",, "icoprint.ico" )
      MenuOption( "Rel.Saídas Cliente/Item",        "LJPESTOQC",, "icoprint.ico" )
      MenuOption( "Rel.Análise para Compra",        "PESTORELANALISE",, "icoprint.ico" )
      MenuOption( "Rel.Formulário Contagem Fisica", "PJPFISICAB",, "icoprint.ico" )
      MenuOption( "Rel.Contagem Física",            "LJPFISICA",, "icoprint.ico" )
      MenuOption( "Produtos em Excel",              "PESTOITEMXLS",, "icoprint.ico" )
      MenuUnDrop()
   MenuOption( "Rel.Financeiro",,, "icoprint.ico" )
      MenuDrop()
      MenuOption( "Rel.Doc.Contas a Receber", "PFINANRELRECEBER",, "icoprint.ico" )
      MenuOption( "Rel.Maiores Clientes",     "PFINANRELMAICLI",, "icoprint.ico" )
      MenuOption( "Rel.Doc.Contas a Pagar",   "PFINANRELPAGAR",, "icoprint.ico" )
      MenuOption( "Rel.Maiores Fornecedores", "PFINANRELMAIFOR",, "icoprint.ico" )
      MenuOption( "Rel.Fluxo de Caixa",       "PFINANRELFLUXO",, "icoprint.ico" )
      MenuUnDrop()
   MenuOption( "Rel.Contábil",,, "icoprint.ico" )
      MenuDrop()
      MenuOption( "Rel.Plano de Contas",                 "PCONTREL0360",, "icoprint.ico" )
      MenuOption( "Rel.Balancete de Verificação",        "PCONTREL0270",, "icoprint.ico" )
      MenuOption( "Rel.Balancete do período",            "PCONTREL0520",, "icoprint.ico" )
      MenuOption( "Rel.Livro Diário",                    "PCONTREL0210",, "icoprint.ico" )
      MenuOption( "Rel.Livro Caixa",                     "PCONTREL0010",, "icoprint.ico" )
      MenuOption( "Rel.Razão/Caixa",                     "PCONTREL0380",, "icoprint.ico" )
      MenuOption( "Rel.Demonstração de Resultado",       "PCONTREL0310",, "icoprint.ico" )
      MenuOption( "Rel.Balanço Patrimonial",             "PCONTREL0320",, "icoprint.ico" )
      MenuOption( "Rel.Termos de Abertura/Encerramento", "PCONTREL0390",, "icoprint.ico" )
      MenuOption( "-", "-" )
      MenuOption( "Rel.Conferência",                     "PCONTREL0250",, "icoprint.ico" )
      MenuOption( "Rel.Contas Admin/C.Custo",            "PCONTREL0550",, "icoprint.ico" )
      MenuOption( "Rel.Despesas por Centro de Custo",    "PCONTREL0300",, "icoprint.ico" )
      MenuOption( "Rel.Retrospectiva de Contas",         "PCONTREL0330",, "icoprint.ico" )
      MenuOption( "Rel.Retrospectiva de Contas-C.Custo", "PCONTREL0530",, "icoprint.ico" )
      MenuOption( "Rel.Razão de Conciliação",            "PCONTREL0385",, "icoprint.ico" )
      MenuOption( "-", "-" )
      MenuOption( "Rel.Cta.Admin x Contábeis",           "PCONTREL0470",, "icoprint.ico" )
      MenuOption( "Rel.Históricos Padrão",               "PCONTREL0370",, "icoprint.ico" )
      MenuOption( "Rel.Lançamentos Padrão",              "PCONTREL0230",, "icoprint.ico" )
      MenuOption( "Rel.Parâmetros do Sistema",           "PCONTREL0340",, "icoprint.ico" )
      MenuUnDrop()
   MenuOption( "Rel.Fiscais",,, "icoprint.ico" )
      MenuDrop()
      MenuOption( "Rel.Conferência LFiscal",                   "PFISCREL0060",, "icoprint.ico" )
      MenuOption( "Rel.DOPUF - ICMS",                          "PFISCREL0070",, "icoprint.ico" )
      MenuOption( "Rel.Defesa Civil",                          "PFISCREL0140",, "icoprint.ico" )
      MenuOption( "Rel.LMP Livro Mov. Produtos",               "PFISCREL0130",, "icoprint.ico" )
      MenuOption( "Rel.Livro Entradas/Saidas (P1/P1A/P2/P2A)", "PFISCREL0030",, "icoprint.ico" )
      MenuOption( "Rel.Livro Produção e Estoque (P3)",         "PFISCREL0010",, "icoprint.ico" )
      MenuOption( "Rel.Livro Apuração de ICMS/IPI (P9)",       "PFISCREL0040",, "icoprint.ico" )
      MenuOption( "Rel.Livro Oper.Interestaduais (P12)",       "PFISCREL0080",, "icoprint.ico" )
      MenuOption( "Rel.Movimentos Irregulares",                "PFISCREL0090",, "icoprint.ico" )
      MenuOption( "Rel.Resumo por UF - ICMS/IPI",              "PFISCREL0100",, "icoprint.ico" )
      MenuOption( "Rel.Resumo por UF/Alíquota",                "PFISCREL0110",, "icoprint.ico" )
      MenuOption( "Rel.Resumo por Uf/Nat/Alíquota",            "PFISCREL0120",, "icoprint.ico" )
      MenuOption( "Rel.Termos de Abertura/Encerramento",       "PFISCREL0020",, "icoprint.ico" )
      MenuOption( "Rel.Resumo por Data",                       "PFISCREL0050",, "icoprint.ico" )
      MenuOption( "Rel.Regras de Tributação",                  "PLEISRELIMPOSTO",, "icoprint.ico" )
      MenuUnDrop()
   MenuOption( "Rel.Cadastros",,, "icoprint.ico" )
      MenuDrop()
      MenuOption( "Rel.Cidades/Países",        "PLEISRELCIDADE",, "icoprint.ico" )
      MenuOption( "Rel.Clientes/Fornecedores", "LJPCADAS",, "icoprint.ico" )
      MenuOption( "Rel.Formas de Pagamento",   "LJPFORPAG",, "icoprint.ico" )
      MenuOption( "Rel.Produtos",              "LJPITEM",, "icoprint.ico" )
      MenuOption( "Rel.Tabelas Auxiliares",    "LJPTABEL",, "icoprint.ico" )
      MenuOption( "Rel.Transportadoras",       "LJPCADAS3",, "icoprint.ico" )
      MenuUnDrop()
   MenuOption( "Gerencial", "LBALGER",, "icoprint.ico" )
   MenuUnDrop()

MenuOption( "Governo" )
   MenuDrop()
   MenuOption( "Arquivo I-SIMP ANP",      "PJPANPMOV",,"icofolderout.ico" )
   MenuOption( "SPED Contábil",           "PCONTSPED",,"icofolderout.ico" )
   MenuOption( "SPED FCONT 2011",         "PCONTFCONT",,"icofolderout.ico" )
   MenuOption( "SPED Fiscal/Pis/Cofins",  "PFISCSPED",,"icofolderout.ico" )
   MenuOption( "Gera LF->Sintegra",       "PFISCSINTEGRA",,"icofolderout.ico" )
...
MenuOption( "Cadastros" )
   ...
   MenuOption( "Licenças" )
      ...
      MenuOption( "Licenças - Tipos",       "PAUXLICTIP",,"icosetup.ico" )
      MenuOption( "Licenças - Objetos",     "PAUXLICOBJ",,"icosetup.ico" )
      MenuOption( "Licenças - Listagem",    "LJPLICMOV",,"icoprint.ico" )
      MenuUnDrop()
   MenuOption( "Plano de Contas",                "PCONTCONTAS" )
   MenuOption( "Produtos/Serviços",              "PJPITEM" )
   MenuOption( "(I)Produtos com preço de custo", "ADMPRECUS",,"icosetup.ico" )
   ...
   MenuOption( "Produtos (Composição)",          "PJPPROMIX",,"icosetup.ico" )
   MenuOption( "Veículos",                       "PJPVEICUL" )
   MenuOption( "Motoristas",                     "PJPMOTORI" )
   MenuOption( "Auxiliares Fiscais",,,"icosetup.ico" )
      MenuDrop()
      MenuOption( "Carta de Correção (Códigos)", "PLEISCORRECAO",,"icosetup.ico" )
      MenuOption( "Cidades/Países",              "PLEISCIDADE",,"icosetup.ico" )
      MenuOption( "CFOP (Natureza de Operação)", "PLEISCFOP",,"icosetup.ico" )
      MenuOption( "CST/CSOSN ICMS",              "PLEISICMCST",,"icosetup.ico" )
      MenuOption( "CNAE (Ramos de Atividade)",   "PLEISCNAE",,"icosetup.ico" )
      MenuOption( "CST IPI",                     "PLEISIPICST",,"icosetup.ico" )
      MenuOption( "CST PIS/Cofins",              "PLEISPISCST",,"icosetup.ico" )
      MenuOption( "Modelos de Doctos Fiscais",   "PLEISMODFIS",,"icosetup.ico" )
      MenuOption( "Enquadramento IPI",           "PLEISIPIENQ",,"icosetup.ico" )
      MenuOption( "Enquadramento PIS/Cofins",    "PLEISPISENQ",,"icosetup.ico" )
      MenuOption( "Estoque Unidade de Medida",   "PLEISPROUNI",,"icosetup.ico" )
//    MenuOption( "NCM - Classificação de Produtos", "XXX",,"icosetup.ico" )
      MenuOption( "Origem da Mercadoria",        "PLEISORIMER",,"icosetup.ico" )
      MenuOption( "Plano de Contas Referencial", "PLEISREFCTA",,"icosetup.ico" )
      MenuOption( "Qualificação do Assinante",   "PLEISQUAASS",,"icosetup.ico" )
      MenuOption( "UFs (Unidades Federativas)",  "PLEISUF",,"icosetup.ico" )
      MenuOption( "IBPT Imposto Acumulado",      "PLEISIBPT",,"icosetup.ico" )
      MenuUnDrop()
   MenuOption( "Auxiliares Financeiros",,,"icosetup.ico" )
      MenuDrop()
      MenuOption( "Bancos",                         "PAUXBANCO",,"icosetup.ico" )
      MenuOption( "Valores do Dólar",               "PJPDOLAR",,"icosetup.ico" )
      MenuOption( "Formas de Pagamento",            "PJPFORPAG",,"icosetup.ico" )
      MenuOption( "Operação (Financeiro)",          "PAUXFINOPE",,"icosetup.ico" )
      MenuOption( "Portadores (Financeiro)",        "PAUXFINPOR",,"icosetup.ico" )
      MenuUnDrop()
   MenuOption( "Auxiliares Outros",,,"icosetup.ico" )
      MenuDrop()
      MenuOption( "Bases de Rastreamento",        "PJPNFBASE",,"icosetup.ico" )
      MenuOption( "Clientes - Grupo de Clientes", "PAUXCLIGRU",,"icosetup.ico" )
      MenuOption( "Clientes - Status",            "PJPCLISTA",,"icosetup.ico" )
      MenuOption( "Empresas/Filiais (Código)",    "PAUXFILIAL",,"icosetup.ico" )
      MenuOption( "Estoque - Departamento",       "PESTODEPTO",,"icosetup.ico" )
      MenuOption( "Estoque - Seção",              "PESTOSECAO",,"icosetup.ico" )
      MenuOption( "Estoque - Grupo",              "PESTOGRUPO",,"icosetup.ico" )
      MenuOption( "Estoque - Localização",        "PESTOLOCAL",,"icosetup.ico" )
      MenuOption( "Mídia (origem)",               "PAUXMIDIA",,"icosetup.ico" )
      MenuOption( "Motivos de Cancelamento",      "PAUXMOTIVO",,"icosetup.ico" )
      MenuOption( "Transação",                    "PJPTRANSA",,"icosetup.ico" )
      MenuUnDrop()
   MenuUnDrop()
...
MenuOption( "Integração" )
   ...
   MenuOption( "XML de NFE" )
      MenuDrop()
      MenuOption( "Envia XML para servidor",         "PDFESALVA",,"icofolderout.ico" )
      MenuOption( "Envia email de NFE",              "PDFEEMAIL",,"icofolderout.ico" )
      MenuOption( "Importa arquivos XML",            "PDFEIMPORTA",,"icofolderin.ico" )
      MenuOption( "Tabela de Conversão",             "PEDI0150",,"icosetup.ico" )
      MenuOption( "Tipos de Conversão",              "PAUXEDICFG",,"icosetup.ico" )
      MenuOption( "Zip de XML/PDF de um mês",        "PDFEZIPXML",,"icofolderout.ico" )
      MenuUnDrop()
   MenuOption( "Gera EDI Financeiro CLARCON",        "PEDIEXPCLARCON",,"icofolderout.ico" )
   MenuOption( "Arquivos de retorno ITAÚ",           "PRETITAU",,"icofolderin.ico" )
   MenuOption( "Importa notas TOPPETRO",             "PEDI0010",,"icofolderin.ico" )
   MenuOption( "Grava NFs no L.Fiscal",              "PFISCNOTAS",,"icofolderout.ico" )
   MenuOption( "Grava LFiscal no Contábil",          "PCONTFISCAL",,"icofolderout.ico" )
   MenuOption( "Exporta Clientes Excel CSV",         "PEDI0270",,"icofolderout.ico" )
   MenuOption( "CT Importa Contas (Entre Empresas)", "PCONTIMPPLANO",,"icofolderin.ico" )
   MenuOption( "CT Importar Excel KITFRAME",         "PCONTIMPEXCEL",,"icofolderin.ico" )
   MenuOption( "CT Importa SPED CONTÁBIL",           "PCONTIMPSPED",,"icofolderin.ico" )
   MenuOption( "Grava Doctos. Seguradora",           "PNOTASEGURO",,"icofolderout.ico" )
   MenuUnDrop()

MenuOption( "Gerente" )
   MenuDrop()
   MenuOption( "Movimentação em Pedidos",         "PNOTACONSPROD" )
   MenuOption( "Acertos Diversos",,,"icosetup.ico" )
      MenuDrop()
      MenuOption( "Checagem/Análise Geral",       "PNOTACHECAGEM",,"icosetup.ico" )
      MenuOption( "Recálculo de Estoque",         "PESTORECALCULO",,"icosetup.ico" )
      MenuUnDrop()
   MenuOption( "Estatística de Uso",              "PADMESTATISTICA" )
   MenuOption( "Log de Utilização do Sistema",    "PADMINLOG",,"icosetup.ico" )
   MenuOption( "(I)Ocorrências Alterar/Excluir",  "ADMOCOALT",,"icosetup.ico" )
   MenuOption( "Usuários/Senhas/Acessos",         "PADMINACESSO",,"icosetup.ico" )
   MenuOption( "Apaga informações antigas",       "PADMINAPAGAANTIGO",,"icosetup.ico" )
   MenuOption( "Número de documento no estoque",  "PESTONUMDOC",,"icosetup.ico" )
   MenuUnDrop()
...
MenuOption( "Sistema" )
   ...
   MenuOption( "Compactação/Reindexação", "JPA_INDEX",,"icosetup.ico" )
   ...
   MenuOption( "Utilitários Diversos" )
      MenuDrop()
      MenuOption( "Acesso Direto a Arquivos",   "PUTILDBASE",,"icosetup.ico" )
      ...
      MenuOption( "Mudança de senha",           { || pw_AlteraSenha() },,"icosetup.ico" )
      MenuOption( "Teclado Virtual",            "PTOOLVKEYBOARD" )
      MenuOption( "Ascii Table",                "PTOOLTABASCII" )
      MenuOption( "Color Table",                "PSETUPCOLOR",,"icosetup.ico" )
      MenuOption( "Windows Modo Deus",          "PTOOLGODMODE" )
      MenuUnDrop()
   MenuOption( "Configurações/Atualizações" )
      MenuDrop()
      MenuOption( "Download Tabelas",              "PEDI0260",,"icosetup.ico" )
      MenuOption( "Importa CNAE EXCEL ANP T002",   "PEDIIMPANPCNAE",,"icosetup.ico" )
      MenuOption( "Importa plano referencial",     "PEDIIMPPLAREF",,"icosetup.ico" )
      MenuOption( "Empresa Usuária",               "PSETUPEMPRESA",,"icosetup.ico" )
      MenuOption( "Numeração do Sistema",          "PSETUPNUMERO",,"icosetup.ico" )
      MenuOption( "Ativação/Desativação",          "PSETUPPARAMALL",, "icosetup.ico" )
      MenuOption( "Contábil Parâmetros",           "PCONTSETUP",,"icosetup.ico" )
      MenuOption( "Contábil Diário Livro/Página",  "PCONTNUMDIA",, "icosetup.ico" )
      MenuOption( "Contábil Relat.Emitidos",       "PCONTEMITIDOS",, "icosetup.ico" )
      MenuOption( "Liberação por telefone",        { || pSetupLibera() },, "icosetup.ico" )
      MenuOption( "Alteração no UAC Windows",      { || pSetupWindows() },, "icosetup.ico" )
      MenuUnDrop()
   MenuOption( "JPA - Servidor/Site" )
      ...
      IF IsMaquinaJPA()
         ...
         MenuOption( "Site josequintas.com.br",       "PSITEJPA",,"icosetup.ico" )
         MenuOption( "Upload de Tabelas",             "PEDI0190" )
         MenuOption( "Importa T001.xls Agentes",      "PEDIIMPANPAGE",,"icosetup.ico" )
         MenuOption( "Importa T008.xls Instalações",  "PEDIIMPANPINS",,"icosetup.ico" )
         MenuOption( "Importa T018.xls Localidades",  "PEDIIMPANPLOC",,"icosetup.ico" )
         MenuOption( "Importa T002.xls Atividades",   "PEDIIMPANPATI",,"icosetup.ico" )
         MenuOption( "Importa IBGE Excel CNAE 21",    "PEDIIMPIBGECNAE",,"icosetup.ico" )
      ENDIF
      MenuUnDrop()
   MenuOption( "Testes" )
      MenuDrop()
      ...
      MenuOption( "Testes JPA" )
         ...
         MenuOption( "Windows Style",                  "PTESWIN",,"icosetup.ico" )
         MenuOption( "MySQL Backup",                   "SQLBACKUP",,"icosetup.ico" )
         MenuOption( "MySQL Exportar para MySQL",      "SQLFROMDBF",,"icosetup.ico" )
         MenuUnDrop()
      MenuOption( "Testes Aplicativo" )
         MenuDrop()
         MenuOption( "Manual Imprimir",              "HELPPRINT",, "icoprint.ico" )
         MenuOption( "Retorna preços diferenciados", "PPRECANCEL",,"icosetup.ico" )
         MenuUnDrop()
      MenuUnDrop()
