...
FUNCTION JPSENHADefault()
   ...
   LOCAL cModule
   LOCAL acCtList    := { "PCONTCTAADM", "PLEISQUAASS", "PCONTREDDISP", "PCONTIMPPLANO", "PEDI0290", "PJPDOLAR", ;
      "PCONTSPED", "PCONTFCONT", "PLEISREFCTA", "PCONTLANCINCLUI", "PCONTLANCLOTE", "PCONTLANCALTERA", "PCONTTOTAIS", ;
      "PCONTSALDO", "PCONTFECHA", "PCONTSINTETICA", "PCONTRECALCULO", "PCONTREDRENUM", "PCONTSETUP", "PCONTNUMDIA", ;
      "PCONTEMITIDOS", "PCONTREL0360", "PCONTREL0270", "PCONTREL0520", "PCONTREL0210", "PCONTREL0010", "PCONTREL0380", ;
      "PCONTREL0310", "PCONTREL0320", "PCONTREL0390", "PCONTREL0250", "PCONTREL0550", "PCONTREL0300", "PCONTREL0330", ;
      "PCONTREL0530", "PCONTREL0385", "PCONTREL0470", "PCONTREL0370", "PCONTREL0230", "PCONTREL0340", "PCONTHISTORICO", ;
      "PCONTLANCPAD", "PCONTCTPLANO", "PFISCREL0020" }
   LOCAL acNFList    := { "PNOT0020", "PNOT0040", "PNOT0060", "PNOT0213", "PNOT0214", "PNFEINUT", "PNOT0070", "P0600PED", ;
       "PLEISIMPOSTO", "PLEISDECRETO", "PLEISTRIPRO", "PLEISTRICAD", "PESTLANCA1", "PESTLANCA2", "PFIN0030", "PFIN0035", ;
       "PFIN0010", "PFIN0040", "PFISCSAIDAS", "PFISCENTRADAS", "PLEISUF", "PLEISTRIEMP", ;
       "PLEISTRIUF", "LJPPEDI", "PNOT0090", "PNOT0120", "LJPESTOQA", "LJPESTOQB", "LJPESTOQC", "PJPFISICAB", ;
       "PFIN0120", "PFIN0130", "PFIN0140", "PFIN0150", "PLEISRELCIDADE", "LJPCADAS", "LJPFORPAG", "LJPITEM", "LJPCADAS3", ;
       "JPCADAS1", "PJPITEM", "PJPCADAS3", "PJPVENDED", "PJPVEICUL", "PJPMOTORI", "PLEISCFOP", "PLEISICMCST", "PLEISMODFIS", ;
       "PLEISIPIENQ", "PLEISPISENQ", "PLEISPROUNI", "PLEISORIMER", "PJPIBPT", "PAUXBANCO", "PAUXFORPAG", "PAUXFINOPE", ;
       "PAUXFINPOR", "PESTODEPTO", "PESTOGRUPO", "PESTOSECAO", "PESTOLOCAL", "PAUXMOTIVO", "PAUXMIDIA", "PAUXMEIAUT", ;
       "PJPTRANSA", "PNFE0010", "PNFE0050", "LLPRECO" }
   LOCAL acComumList := { "LJPTABEL", "PAUXCCUSTO", "PAUXCLISTA", "PAUXFILIAL", "PLEISIPICST", "PLEISPISCST", ;
      "PSETUPEMPRESA", "PCFG0055", "PLEISCIDADE", "PJPEMPRE", "PSETUPNUMERO", "PJPTABEL", "PLEISUF", "PUTI0010", "PUTI0020", ;
      "PUTI0022", "PADMINLOG", "PUPDATEEXEDOWN", "PSETUPEMPRESA" }

   SayScroll( "Ajustando acessos do usuário CT" )
   ...
   IF Eof()
      ...
      pw_GravaUsuarioGrupo( "CT", "GRUPOTESTE2" )
      pw_GravaUsuarioGrupo( "TESTE", "GRUPOTESTE1" )
      pw_GravaUsuarioGrupo( "TESTE", "GRUPOTESTE2" )
      pw_GravaGrupo( "GRUPOCONTABIL" )
      pw_GravaGrupo( "GRUPOTESTE1" )
      pw_GravaGrupo( "GRUPOTESTE2" )
      FOR EACH cModule IN acCtList
         pw_GravaUsuarioAcesso( "GRUPOCONTABIL", cModule )
      NEXT
      FOR EACH cModule IN acNFList
         pw_GravaUsuarioAcesso( "GRUPOTESTE1", cModule )
      NEXT
      FOR EACH cModule IN acComumList
         pw_GravaUsuarioAcesso( "GRUPOTESTE2", cModule )
      NEXT
   ENDIF
   CLOSE DATABASES
